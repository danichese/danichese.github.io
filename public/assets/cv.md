...
#### **Security Service Owner & Technical Writer** | University of Manchester
*Sept 2024 – Present (Remote)*
- Designed the university’s first Security Service Catalogue, mapping 12 core security applications to the NIST CSF framework.
- Overhauled the documentation operating model to ensure 24/7 support readiness for security incidents.

#### **Senior Client Support (Team Lead)** | Total Processing
*Aug 2022 – Dec 2023*
...
*Dec 2020 – Apr 2022*
- Technical lead for a critical infrastructure migration of 500+ users to a new VDI environment.
- Authored core Standard Operating Procedures (SOPs) that significantly improved global Service Desk consistency.

#### **IT Service Desk Analyst** | Parliamentary and Health Service Ombudsman
*Sept 2020 – Dec 2020*
- Managed user access and service health via Azure Portal, executing technical runbooks for cloud-based application support.
...
### HOBBIES & INTERESTS
Futurology, Astronomy, Tech Trends, and AI-Assisted Creativity.
